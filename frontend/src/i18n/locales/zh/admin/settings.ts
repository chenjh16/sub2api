export default {
    settings: {
      ...
      site: {
        ...
        modelMappingAutoRulesHint: '启用的规则会把来源模型名自动映射到目标模型名；“自动映射”发现的新规则也会追加到这里',
        ...
        modelMappingFromPlaceholder: '来源模型，如 DeepSeek-V4-Pro',
        modelMappingToPlaceholder: '目标模型，如 deepseek-v4-pro',
