    ...
    groups: {
      ...
      openaiMessages: {
        ...
        defaultServiceTierHint:
          'OpenAI Responses, Chat Completions, and Realtime requests without an explicit service_tier will use this value. Explicit client values are preserved unless Force OpenAI Fast is enabled.',
