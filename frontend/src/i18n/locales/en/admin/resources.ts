export default {
    scheduledTests: {
      ...
      selectFilteredModels: 'Select current results',
      ...
      createSuccessCount: '{count} plans created',
      createPartialFailed: 'Some plans failed to create: {success} succeeded, {failed} failed',
