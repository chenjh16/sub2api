export default {
    settings: {
      ...
      site: {
        ...
        modelMappingAutomationTitle: 'Model Mapping Automation',
        modelMappingAutomationDescription: 'Manage the global whitelist used by Auto Rule Mapping in account dialogs, and configure the default model batch-test concurrency',
        modelBatchTestConcurrency: 'Batch Test Concurrency',
        modelBatchTestConcurrencyHint: 'Used by batch model tests in the account edit dialog. Range 1-10, default 3',
        modelMappingAutoRules: 'Auto Naming Rule Whitelist',
        modelMappingAutoRulesHint: 'Enabled rules map request models to actual upstream models. Newly discovered Auto Mapping rules are appended here as well',
        addModelMappingRule: 'Add Rule',
        saveModelMappingAutomation: 'Save Automation Settings',
        loadModelMappingAutomationFailed: 'Failed to load model mapping automation settings',
        saveModelMappingAutomationSuccess: 'Model mapping automation settings saved',
        saveModelMappingAutomationFailed: 'Failed to save model mapping automation settings',
        modelMappingFromPlaceholder: 'Request model, e.g. deepseek-v4-pro',
        modelMappingToPlaceholder: 'Actual upstream model, e.g. DeepSeek-V4-Pro',
        modelMappingRuleSourcePlaceholder: 'Source note',
        modelMappingAutoRulesEmpty: 'No rules yet. Add one manually, or use Auto Mapping in an account dialog to append discovered rules',
        customEndpoints: {
      ...
      gatewayFailoverPolicy: {
        ...
        matchModeFirst: 'First match by priority',
        ...
        ruleId: 'Rule ID',
        event: 'Event',
        httpEvent: 'HTTP Response',
        transportEvent: 'Transport Error',
        priority: 'Priority',
        descriptionLabel: 'Description',
        statusCodes: 'Status Codes',
        excludeStatusCodes: 'Excluded Status Codes',
        statusRanges: 'Status Ranges',
        jsonConditionGroup: 'JSON Condition Group',
        headerConditionGroup: 'Header Condition Group',
        messageConditionGroup: 'Message Condition Group',
        bodyConditionGroup: 'Body Condition Group',
        transportConditionGroup: 'Transport Condition Group',
        maxScanBytes: 'Max Scan Bytes',
        jsonLogic: 'JSON Logic',
        headerLogic: 'Header Logic',
        jsonConditions: 'JSON Conditions',
        headerConditions: 'Header Conditions',
        messageConditions: 'Message Conditions',
        bodyConditions: 'Body Conditions',
        transportConditions: 'Transport Conditions',
        transportPersistent: 'Transport Error Type',
        any: 'Any',
        transient: 'Transient',
        ...
        jsonRulesRequired: 'JSON must be a rule array or an object containing a rules array',
