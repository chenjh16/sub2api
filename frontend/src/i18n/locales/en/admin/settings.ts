export default {
    settings: {
      ...
      site: {
        ...
        modelMappingAutoRulesHint: 'Enabled rules map source model names to target model names. Newly discovered Auto Mapping rules are appended here as well',
        ...
        modelMappingFromPlaceholder: 'Source model, e.g. DeepSeek-V4-Pro',
        modelMappingToPlaceholder: 'Target model, e.g. deepseek-v4-pro',
