export default {
    accounts: {
      ...
      autoMapAdded: 'Appended {count} model mapping(s) and updated the global rule whitelist',
      autoRuleMapAdded: 'Appended {count} model mapping(s) from the global rule whitelist',
