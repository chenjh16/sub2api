export default {
    accounts: {
      ...
      collapseToolbarHint: 'Hide account actions, filters, and bulk edit bar to maximize table height',
      expandToolbarHint: 'Show account actions, filters, and bulk edit bar',
      ...
      modelAutoRefreshTitle: 'Auto-refresh model list',
      modelAutoRefreshDescription: 'Periodically fetch upstream /models for this account and update model candidates.',
      modelAutoRefreshToggle: 'Enable or disable model auto-refresh',
      modelAutoRefreshInterval: 'Refresh interval (minutes)',
      modelAutoRefreshIntervalHint: 'Minimum 10 minutes, maximum 30 days.',
      modelAutoRefreshTestFilter: 'Test after fetch and filter unavailable models',
      modelAutoRefreshTestFilterHint: 'When enabled, models are tested using the global batch-test concurrency, and only passing models enter the effective model list.',
      autoRuleMapModels: 'Auto Rule Mapping',
      autoMapModels: 'Auto Mapping',
      autoMapNoModels: 'No models to analyze',
      autoMapNoChanges: 'No model mappings to append',
      autoMapAdded: 'Updated {count} model mapping(s) and synchronized the global rule whitelist',
      autoRuleMapAdded: 'Updated {count} model mapping(s) from the global rule whitelist',
      autoMappingSettingsLoadFailed: 'Failed to load model mapping automation settings',
      autoMappingSettingsSaveFailed: 'Failed to update the model mapping rule whitelist',
      batchTestModels: 'Batch Test Models',
      batchTestingModels: 'Testing...',
      batchTestModelsDone: 'Tested {success}/{total}, failed {failed}',
      modelBatchTestResults: 'Model Test Results',
      testThisModel: 'Test this model',
      modelTestTotal: 'Total',
      modelTestSuccess: 'Success',
      modelTestFailed: 'Failed',
      modelTestRunning: 'Testing',
      modelTestNotRun: 'Not tested',
      modelTestError: 'Test failed',
      modelTestPassed: 'Test passed',
      modelTestQueued: 'Queued',
      modelTestImageReceived: 'Image response received',
      modelTestRequiresSavedAccount: 'Save the account before testing models',
      modelTestNoResponseBody: 'The test API returned no response body',
      modelTestStreamEnded: 'The test stream ended without a completion event',
      removeModel: 'Remove this model',
      enableModel: 'Enable this model',
      disableModel: 'Disable this model',
      ...
      enabledModelCount: '{enabled} enabled / {total} candidates',
      poolMode: 'Pool Mode',
