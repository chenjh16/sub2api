...
func provideCleanup(
	...
	accountModelAutoRefresh *service.AccountModelAutoRefreshService,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"AccountModelAutoRefreshService", func() error {
				if accountModelAutoRefresh != nil {
					accountModelAutoRefresh.Stop()
				}
				return nil
			}},
